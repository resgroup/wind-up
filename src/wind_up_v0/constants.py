...
PROJECTROOT_DIR = Path(__file__).parents[2]
CONFIG_DIR = Path(__file__).parents[2] / "config"
TURBINE_DATA_DIR = Path(__file__).parents[2] / "input_data/turbine_data"
REANALYSIS_DIR = Path(__file__).parents[2] / "input_data/reanalysis"
TOGGLE_DIR = Path(__file__).parents[2] / "input_data/toggle"
