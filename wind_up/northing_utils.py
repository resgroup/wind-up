...
from wind_up.constants import RAW_DOWNTIME_S_COL, RAW_POWER_COL, TIMEBASE_S

YAW_OK_PW_FRACTION = 0.05


def add_ok_yaw_col(wf_or_wtg_df: pd.DataFrame, *, new_col_name: str, wd_col: str, rated_power: float) -> pd.DataFrame:
